    ...
    const heroes = [
      {
        ...
        images: ['https://dummyjson.com/image/300', 'https://dummyjson.com/image/300']
      },
      {
        nickname: 'Dark Knight',
        real_name: 'Bruce Wayne',
        origin_description: 'Witnessed parents murder, trained to physical perfection',
        superpowers: ['Master Detective', 'Martial Arts Expert', 'Advanced Technology'],
      ...
      },
      {
        ...
        superpowers: ['Master Archery', 'Tactical Planning', 'Peak Human Combat'],
        images: []
      },
      {
        ...
        catch_phrase: "Life is locomotion... if you're not moving, you're not living.",
        images: ['https://dummyjson.com/image/300']
      },
      {
        nickname: 'Jade Giant',
      ...
      },
      {
        ...
        superpowers: ['Flight', 'Super Strength', 'Heat Vision', 'Invulnerability'],
